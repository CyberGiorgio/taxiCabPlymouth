            ...
            <div class="materialContainer">
                <div class="box"  align="center" >
                    <div class="title">
                     ...
                     <div>
                            <p> collected data during the use of our services we may collect data which makes you identifiable we reserve the right to collect<br>
&#8226; gps data <br>
&#8226; name<br>
&#8226; email address <br>
the purpose for collecting data<br>
we collect your data with the sole purpose of providing our services and database with the required data for working functionality without the collection of this data the services will not work as intended and cannot be allowed we collect this data 
during the use of our services we may collect data which makes you identifiable
we reserve the right to collect<br>
&#8226; gps tracking data<br>
&#8226; input_forms<br>
&#8226; handling your data<br>
your data will be used for the functionality of our services and will not be sold or shared with any other parties outside of taxiCabPlymouth inc<br>
data will be held in full compliance with regulations and timeframes required under gdpr</p><br>
                    </div>
               </div>
            </div>
        </div>
